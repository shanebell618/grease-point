...
flow's file layout (`src/app/api/equipment/`, `src/features/equipment/`),
...
- [ ] **Maintenance** — [`src/features/maintenance/README.md`](src/features/maintenance/README.md)
- [ ] **Parts Inventory** — [`src/features/inventory/README.md`](src/features/inventory/README.md)
- [ ] **Documents** — [`src/features/documents/README.md`](src/features/documents/README.md)
- [ ] **Analytics / charts** — [`src/features/analytics/README.md`](src/features/analytics/README.md)
...
- [ ] **Auth** (JWT or Google login) — [`src/features/auth/README.md`](src/features/auth/README.md)
...
- [ ] **Optimistic updates** — TODO comment on `useDeleteEquipmentMutation` in [`src/features/equipment/hooks.ts`](src/features/equipment/hooks.ts). Delete is the natural first candidate: remove the item from the `equipmentKeys.list()` cache in `onMutate`, roll back `onError`, skip the invalidate-on-success round trip.
...
- Reusable, presentational components (tables, badges, cards) go in
  `src/components/` with a co-located `.stories.tsx`; feature-specific
  components stay under `src/features/<name>/components/`.
